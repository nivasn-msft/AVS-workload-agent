...
Issues and pull requests are welcome. If you exercise the **Gen 2** path, or add a driver for another database engine, please open a PR — those are the two most valuable gaps.
